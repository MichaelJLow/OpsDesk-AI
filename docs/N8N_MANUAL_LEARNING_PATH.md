...
| 8 | HubSpot contact lookup | Upcoming |
| 9 | Supabase property/site lookup | Upcoming |
| 10 | Deterministic routine route + Slack | Upcoming |
| 11 | Draft reply + store | Upcoming |
...
**Lesson 7** done 2026-07-24 (Zod via automation-api `:3040`; IF boolean type; mark `valid`/`invalid`). Domain = Quayside / boiler / Riverside Court.
